  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Everything you need to help your young scientist succeed at the MV Science Fair."
      />
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed">
                ...
                message from <strong className="text-text-primary">the Science Fair Committee</strong>.
