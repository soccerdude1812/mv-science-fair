      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-10">
        ...
        <div className="clean-card p-8 sm:p-10 border-t-2 border-t-accent-primary">
          <div className="flex flex-col sm:flex-row items-start gap-6">
            <div className="shrink-0 w-16 h-16 rounded-2xl bg-accent-primary-light text-accent-primary flex items-center justify-center" aria-hidden="true">
            ...
            <div>
              ...
              <Link
                href="/the-process"
                className="inline-flex items-center gap-2 px-6 py-3 bg-accent-primary text-white font-semibold rounded-xl hover:bg-accent-primary-hover transition-colors"
              >
        ...
        <div className="clean-card p-6 sm:p-8">
          <div className="flex items-start gap-4">
            <div className="shrink-0 w-10 h-10 rounded-lg bg-accent-warm-light text-accent-warm flex items-center justify-center" aria-hidden="true">
            ...
            <div>
              <h2 className="text-xl font-display font-bold text-text-heading mb-2">
                After Registration
              </h2>
        ...
        {/* Quick Links */}
        <div className="clean-card p-6 sm:p-8">
          <h2 className="text-xl font-display font-bold text-text-heading mb-4">Quick Links</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <Link
              href="/display-and-safety"
              className="flex items-center gap-3 p-4 rounded-lg bg-bg-light border border-border-default hover:border-accent-primary transition-all group"
            >
              <div className="w-8 h-8 rounded-lg bg-accent-primary-light text-accent-primary flex items-center justify-center shrink-0" aria-hidden="true">
            ...
            <Link
              ...
              className="flex items-center gap-3 p-4 rounded-lg bg-bg-light border border-border-default hover:border-accent-primary transition-all group"
            >
              <div className="w-8 h-8 rounded-lg bg-accent-secondary-light text-accent-secondary flex items-center justify-center shrink-0" aria-hidden="true">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <Link
              ...
              className="flex items-center gap-3 p-4 rounded-lg bg-bg-light border border-border-default hover:border-accent-primary transition-all group"
            >
              <div className="w-8 h-8 rounded-lg bg-accent-warm-light text-accent-warm flex items-center justify-center shrink-0" aria-hidden="true">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <Link
              ...
              className="flex items-center gap-3 p-4 rounded-lg bg-bg-light border border-border-default hover:border-accent-primary transition-all group"
            >
              <div className="w-8 h-8 rounded-lg bg-accent-rose-light text-accent-rose flex items-center justify-center shrink-0" aria-hidden="true">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Contact */}
        <div className="clean-card p-8 text-center border-t-2 border-t-accent-primary">
          <h2 className="text-2xl font-display font-bold text-text-heading mb-3">Questions?</h2>
