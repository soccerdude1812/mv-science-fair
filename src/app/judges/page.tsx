      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-10">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-8">
          <div className="flex flex-col sm:flex-row items-start gap-6">
            <div className="shrink-0 w-16 h-16 rounded-2xl bg-indigo-50 text-accent flex items-center justify-center" aria-hidden="true">
            ...
            <div>
              ...
              <p className="text-lg text-slate-700 leading-relaxed">
                We&apos;re looking for <strong>high school graduates</strong>{" "}
        ...
        {/* Sign Up CTA */}
        <div className="bg-gradient-to-br from-indigo-50 to-cyan-50 rounded-2xl p-8 sm:p-10 border border-indigo-100 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-accent text-white font-bold text-lg rounded-xl hover:bg-cyan-700 transition-colors shadow-lg shadow-accent/20"
          >
            Sign Up to Judge
